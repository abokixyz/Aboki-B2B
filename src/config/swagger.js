    ...
    components: {
      securitySchemes: {
        ...
        ApiKeyAuth: {
          ...
          example: 'pk_live_f3e1230d1f229806ea24d2f80dc128a1'
        },
        SecretKeyAuth: {
          type: 'apiKey',
          in: 'header', 
...
const swaggerSetup = (app) => {
  try {
    ...
    app.use('/api-docs', swaggerUi.serve, swaggerUi.setup(specs, {
      ...
      swaggerOptions: {
        ...
        preauthorizeApiKey: {
          'X-API-Key': 'pk_live_f3e1230d1f229806ea24d2f80dc128a1',
      ...
      customJs: [
        ...
        window.addEventListener('DOMContentLoaded', function() {
          ...
          setTimeout(function() {
            ...
            if (apiKeyInput) {
              apiKeyInput.placeholder = 'pk_live_f3e1230d1f229806ea24d2f80dc128a1';
    ...
    app.get('/api-docs/health', (req, res) => {
      ...
      res.json({
        ...
        authenticationExamples: {
          apiKey: 'pk_live_f3e1230d1f229806ea24d2f80dc128a1',
  ...
  -H 'X-API-Key: pk_live_f3e1230d1f229806ea24d2f80dc128a1'`
          },
          fullAuthentication: {
  ...
  -d '{ "customerEmail": "customer@example.com", ... }'`
        ...
        keyFormats: {
          apiKey: {
            ...
            examples: {
              live: 'pk_live_f3e1230d1f229806ea24d2f80dc128a1',
